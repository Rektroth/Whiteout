...
| [MC-300685](https://bugs.mojang.com/browse/MC-300685) | Paper  | Running '/waypoint modify' on an entity in another dimension causes the waypoint to appear in the executor's dimension |
