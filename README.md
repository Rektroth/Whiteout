...
| [MC-302297](https://bugs.mojang.com/browse/MC-302297) | Paper           | ❌                  | Swapping an item stack from a GUI into the offhand on the same tick the player's inventory is cleared creates a ghost item           |
