...
| [MC-33041](https://bugs.mojang.com/browse/MC-33041)   | CraftBukkit     | ✔️                 | Dedicated server logs "java.io.IOException: The handle is invalid" on startup                                                        |
...
| [MC-121706](https://bugs.mojang.com/browse/MC-121706) | Purpur          | ✔️                 | Skeletons and illusioners aren't looking up / down at their target while strafing                                                    |
...
| [MC-151857](https://bugs.mojang.com/browse/MC-151857) | Paper           | ❌                  | Wrong string displayed upon /give used for multiple players                                                                          |
...
| [MC-157395](https://bugs.mojang.com/browse/MC-157395) | CraftBukkit     | ✔️                 | Small armor stands drop no loot table                                                                                                |
...
| [MC-259832](https://bugs.mojang.com/browse/MC-259832) | Paper           | ✔️                 | Combination of potion effect durations and amplifiers will cause a specific effect to disappear                                      |
...
| [MC-297169](https://bugs.mojang.com/browse/MC-297169) | Paper           | ✔️                 | Happy Ghast with Silent tag plays happy ghast sounds when mounted/dismounted                                                         |
...
| [MC-301114](https://bugs.mojang.com/browse/MC-301114) | Paper           | ❌                  | Memory leak when an entity is frequently damaged                                                                                     |
...
- Mojang has not assigned the ticket a priority, meaning that a Mojang employee has not yet personally reviewed the ticket and confirmed that the described behavior is unintentional
- Mojang closed the ticket with the "Cannot Reproduce" resolution, meaning that a Mojang employee was unable to reproduce the described issue
- Mojang closed the ticket with the "Won't Fix" resolution, meaning that the behavior is confirmed unintentional but they don't care enough to fix it themselves
...
[While some contributors to the Paper project chose to release their code under the more permissive MIT License](https://github.com/PaperMC/Paper/blob/master/LICENSE.md), it is easier, and legally permissible, to release this entire project under the GPLv3.
